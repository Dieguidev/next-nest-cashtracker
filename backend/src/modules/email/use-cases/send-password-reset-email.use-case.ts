    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${envs.frontendUrl}/auth/new-password" style="display: inline-block; padding: 10px 20px; font-size: 18px; font-weight: bold; color: #fff; background-color: #dc3545; text-decoration: none; border-radius: 5px;">Restablecer Contraseña</a>
        </div>
